...
from erp_shared.exceptions import InvalidPasswordError
...
def create_access_token(
    ...
    if expires_delta:
        ...
        expires_time += timedelta(minutes=expire_minutes)
    ...
    return jwt.encode(payload=curr_data, key=secret_key, algorithm=algorithm)
...
def create_refresh_token(
    ...
    """
    curr_data = data.copy()
    expires_time = datetime.now(tz=UTC) + timedelta(days=expire_days)
